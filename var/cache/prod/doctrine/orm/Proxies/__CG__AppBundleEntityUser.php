...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'addresse', 'nom', 'pseudo', 'email', 'ville', 'region', 'codepostal', 'ratioheure', 'compteactif', 'telephone', 'choix_tel', 'img', 'username', 'usernameCanonical', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
