...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'addresse', 'nom', 'prenom', 'ville', 'region', 'codepostal', 'ratioheure', 'telephone', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'besoins', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'services', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setRatioheure($ratioheure)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRatioheure', [$ratioheure]);

        return parent::setRatioheure($ratioheure);
    }
    ...
    public function getRatioheure()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRatioheure', []);

        return parent::getRatioheure();
    }
    ...
    public function setChoixTel($choixTel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChoixTel', [$choixTel]);

        return parent::setChoixTel($choixTel);
    }
    ...
    public function getChoixTel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getChoixTel', []);

        return parent::getChoixTel();
    }
     ...
     * {@inheritDoc}
     */
    public function setBesoins(\AppBundle\Entity\Besoin $besoin)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBesoins', [$besoin]);

        return parent::setBesoins($besoin);
    }
    ...
    public function getBesoins()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBesoins', []);

        return parent::getBesoins();
    }

    /**
     * {@inheritDoc}
     */
    public function setServices(\AppBundle\Entity\Service $service)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setServices', [$service]);

        return parent::setServices($service);
    }
