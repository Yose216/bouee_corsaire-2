    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/besoin') {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                ...
                goto not_besoin_index;
            }

            return array (  '_controller' => 'AppBundle\\Controller\\BesoinController::indexAction',  '_route' => 'besoin_index',);
        }
        not_besoin_index:

        // besoin_new
        if ($pathinfo === '/profile/besoin/new') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                goto not_besoin_new;
            }

            return array (  '_controller' => 'AppBundle\\Controller\\BesoinController::newAction',  '_route' => 'besoin_new',);
        }
        not_besoin_new:

        // besoin_show
        if (0 === strpos($pathinfo, '/besoin') && preg_match('#^/besoin/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_besoin_show;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'besoin_show')), array (  '_controller' => 'AppBundle\\Controller\\BesoinController::showAction',));
        }
        not_besoin_show:

        // besoin_edit
        if (0 === strpos($pathinfo, '/admin') && preg_match('#^/admin/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                goto not_besoin_edit;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'besoin_edit')), array (  '_controller' => 'AppBundle\\Controller\\BesoinController::editAction',));
        }
        not_besoin_edit:

        // besoin_delete
        if (0 === strpos($pathinfo, '/besoin/delete') && preg_match('#^/besoin/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'DELETE') {
                $allow[] = 'DELETE';
                goto not_besoin_delete;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'besoin_delete')), array (  '_controller' => 'AppBundle\\Controller\\BesoinController::deleteAction',));
        }
        not_besoin_delete:
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if ($pathinfo === '/admin/user') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::adminDelete',  '_route' => 'supUser',);
            }
        ...
        // service_new
        if ($pathinfo === '/profile/service/new') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        // service_show
        if (0 === strpos($pathinfo, '/service') && preg_match('#^/service/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
